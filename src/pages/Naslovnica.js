...
import { Link } from 'react-router-dom'; // DODANO ZA ISPRAVNE LINKOVE
...
const Naslovnica = () => {
  return (
    <main className="happy-main">
      {/* 1. HERO SEKCIJA */}
      <section className="hero-h" style={{ backgroundImage: `url('/ncacic/img/hero-h.png')` }}>
        <div className="hero-overlay"></div>
        <div className="container hero-content">
          <h1 className="naslov-1">Tvoje tijelo zaslužuje biti sretno i zdravo!</h1>
          <p className="podnaslov">
            Pronađi balans kroz moć aromaterapije, iscjeljujući dodir masaže i duhovni rad koji te vraća sebi.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="service-row">
            <div className="service-img-wrapper">
              <img src="/ncacic/img/klasicna-hero.png" alt="Klasična masaža" className="rounded-img" />
            </div>
            <div className="service-text">
              ...
              <Link to="/klasicna-masaza" className="link-saznaj-vise">Saznaj više o klasičnoj masaži &rarr;</Link>
            </div>
          </div>
          ...
          <div className="service-row reverse">
            <div className="service-img-wrapper">
              <img src="/ncacic/img/relax.png" alt="Relax masaža" className="rounded-img" />
            </div>
            <div className="service-text">
              ...
              <Link to="/relax-masaza" className="link-saznaj-vise">Saznaj više o relax masaži &rarr;</Link>
            </div>
          </div>
          ...
          <div className="service-row">
            <div className="service-img-wrapper">
              <img src="/ncacic/img/sportska.png" alt="Sportska masaža" className="rounded-img" />
            </div>
            <div className="service-text">
              ...
              <Link to="/sportska-masaza" className="link-saznaj-vise">Saznaj više o sportskoj masaži &rarr;</Link>
            </div>
          </div>
      ...
      <section id="aromaterapija" className="aroma-kontakt py-5">
        <div className="container">
          <div className="aroma-content text-center mb-5">
            ...
            <p className="aroma-opis">
              Moja strast prema biljkama pretočena je u male serije proizvoda koji poštuju ritam prirode i potrebe tvog tijela. 
              Svaka krema, ulje i macerat nastali su s namjerom da podrže tvoje zdravlje na najnježniji način – direktno iz prirode u tvoj dom.
            </p>
          </div>
          ...
          <div className="service-row">
            <div className="service-img-wrapper">
              <img src="/ncacic/img/krema-1.png" alt="Ljekovite kreme i melemi" className="rounded-img" />
            </div>
            <div className="service-text">
              ...
              {/* Ostavljam prazan href ako još nemaš stranicu za aromaterapiju */}
              <Link to="#" className="link-saznaj-vise">Saznaj više o kremama &rarr;</Link>
            </div>
          </div>

          {/* Aromaterapijska ulja */}
          <div className="service-row reverse">
            <div className="service-img-wrapper">
              <img src="/ncacic/img/ulja-2.png" alt="Aromaterapijska ulja" className="rounded-img" />
            </div>
            <div className="service-text">
              ...
              <Link to="#" className="link-saznaj-vise">Saznaj više o uljima &rarr;</Link>
            </div>
          </div>
          ...
          <div className="service-row">
            <div className="service-img-wrapper">
              <img src="/ncacic/img/ulja-1.png" alt="Macerati" className="rounded-img" />
            </div>
            <div className="service-text">
              ...
              <Link to="#" className="link-saznaj-vise">Saznaj više o maceratima &rarr;</Link>
            </div>
          </div>
          ...
          <div className="text-center mt-5">
            <div className="call-box mt-5">
              ...
              <p>Budući da su moji pripravci rađeni u malim serijama i često su sezonski, najviše volim kad se čujemo direktno.</p>
              <a href="https://wa.me/385976065629?text=Pozdrav!%20Zanimaju%20me%20vaši%20ručno%20rađeni%20pripravci%20i%20trebam%20savjet." className="btn-primary mt-4" target="_blank" rel="noopener noreferrer">NAZOVI ZA SAVJET I NARUDŽBU</a>
            </div>
          </div>
        </div>
      </section>
